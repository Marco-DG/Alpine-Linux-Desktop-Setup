mkdir Alpine-Linux-Desktop-Setup
cd Alpine-Linux-Desktop-Setup

wget https://raw.githubusercontent.com/Marco-DG/Alpine-Linux-Desktop-Setup/master/01_edge-main-repo.sh
wget https://raw.githubusercontent.com/Marco-DG/Alpine-Linux-Desktop-Setup/master/02_create-user-lock-root.sh
